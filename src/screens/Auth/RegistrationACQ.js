...
class RegistrationACQ extends Component{
    ...
    render(){
        ...
        const { email, password, confermeEmail, accept,confermePassword } = this.state;
...
export default withStyles(styles)(RegistrationACQ);